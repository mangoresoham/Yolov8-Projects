...
cap=cv2.VideoCapture('D:\Programming\Projects\YOLO\Videos\people.mp4')     #For Video
model=YOLO("D:\Programming\Projects\YOLO\YoloWeights\yolov8l.pt")
...
mask=cv2.imread('D:\Programming\Projects\YOLO\Project 2 People Counter\mask-1.png')
...
while True:
    ...
    imgGraphics=cv2.imread("Project 2 People Counter/graphics-1.png",cv2.IMREAD_UNCHANGED)
    ...
    cv2.putText(img,str(len(totalCountUp)),(929,345),cv2.FONT_HERSHEY_PLAIN,5,(0,195,74),7)
